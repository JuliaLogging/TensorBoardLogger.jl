...
mutable struct FunctionDef_ControlRetEntry <: ProtoType
    key::AbstractString
    value::AbstractString
    FunctionDef_ControlRetEntry(; kwargs...) = (o=new(); fillunset(o); isempty(kwargs) || ProtoBuf._protobuild(o, kwargs); o)
...
export FunctionDefLibrary, FunctionDef_AttrEntry, FunctionDef_RetEntry, FunctionDef_ControlRetEntry, FunctionDef, GradientDef
# mapentries: "FunctionDef_AttrEntry" => ("AbstractString", "AttrValue"), "FunctionDef_RetEntry" => ("AbstractString", "AbstractString"), "FunctionDef_ControlRetEntry" => ("AbstractString", "AbstractString")

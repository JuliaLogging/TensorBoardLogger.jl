...
# original file: tensorboard/plugins/custom_scalar/layout.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:MultilineChartContent}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"MarginChartContent.Series"}, _endpos::Int=0, _group::Bool=false)
    value = ""
    lower = ""
    upper = ""
    while !PB.message_done(d, _endpos, _group)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:MarginChartContent}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:Chart}, _endpos::Int=0, _group::Bool=false)
    title = ""
    content = nothing
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:Category}, _endpos::Int=0, _group::Bool=false)
    title = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:Layout}, _endpos::Int=0, _group::Bool=false)
    version = zero(Int32)

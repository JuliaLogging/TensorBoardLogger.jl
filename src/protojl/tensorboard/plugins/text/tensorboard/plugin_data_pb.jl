...
# original file: tensorboard/plugins/text/plugin_data.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:TextPluginData}, _endpos::Int=0, _group::Bool=false)
    version = zero(Int32)

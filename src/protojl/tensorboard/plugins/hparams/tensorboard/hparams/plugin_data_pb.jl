...
# original file: tensorboard/plugins/hparams/plugin_data.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SessionEndInfo}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SessionStartInfo}, _endpos::Int=0, _group::Bool=false)
    hparams = Dict{String,google.protobuf.Value}()
    model_uri = ""
    monitor_url = ""
    group_name = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:HParamsPluginData}, _endpos::Int=0, _group::Bool=false)
    version = zero(Int32)
    data = nothing
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)

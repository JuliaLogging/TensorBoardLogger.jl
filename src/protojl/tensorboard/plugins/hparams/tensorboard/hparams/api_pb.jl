...
# original file: tensorboard/plugins/hparams/api.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:Interval}, _endpos::Int=0, _group::Bool=false)
...
PB.default_values(::Type{GetExperimentRequest}) = (;experiment_name = "", include_metrics = false, hparams_limit = zero(Int32))
PB.field_numbers(::Type{GetExperimentRequest}) = (;experiment_name = 1, include_metrics = 2, hparams_limit = 3)

function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:GetExperimentRequest}, _endpos::Int=0, _group::Bool=false)
    experiment_name = ""
    include_metrics = false
    hparams_limit = zero(Int32)
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
        if field_number == 1
            experiment_name = PB.decode(d, String)
        elseif field_number == 2
            include_metrics = PB.decode(d, Bool)
        elseif field_number == 3
            hparams_limit = PB.decode(d, Int32)
        else
            Base.skip(d, wire_type)
        end
    end
    return GetExperimentRequest(experiment_name, include_metrics, hparams_limit)
end
...
function PB.encode(e::PB.AbstractProtoEncoder, x::GetExperimentRequest)
    ...
    x.include_metrics != false && PB.encode(e, 2, x.include_metrics)
    x.hparams_limit != zero(Int32) && PB.encode(e, 3, x.hparams_limit)
    return position(e.io) - initpos
end
function PB._encoded_size(x::GetExperimentRequest)
    ...
    x.include_metrics != false && (encoded_size += PB._encoded_size(x.include_metrics, 2))
    x.hparams_limit != zero(Int32) && (encoded_size += PB._encoded_size(x.hparams_limit, 3))
    return encoded_size
end
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:MetricName}, _endpos::Int=0, _group::Bool=false)
    group = ""
    tag = ""
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
...
PB.default_values(::Type{HParamInfo}) = (;name = "", display_name = "", description = "", var"#type" = var"#DataType".DATA_TYPE_UNSET, domain_discrete = nothing, domain_interval = nothing, differs = false)
PB.field_numbers(::Type{HParamInfo}) = (;name = 1, display_name = 2, description = 3, var"#type" = 4, domain_discrete = 5, domain_interval = 6, differs = 7)

function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:HParamInfo}, _endpos::Int=0, _group::Bool=false)
    name = ""
    display_name = ""
    description = ""
    ...
    while !PB.message_done(d, _endpos, _group)
        ...
        elseif field_number == 7
            differs = PB.decode(d, Bool)
        else
            Base.skip(d, wire_type)
        end
    end
    return HParamInfo(name, display_name, description, var"#type", domain, differs)
end
...
function PB.encode(e::PB.AbstractProtoEncoder, x::HParamInfo)
    ...
    x.differs != false && PB.encode(e, 7, x.differs)
    return position(e.io) - initpos
end
function PB._encoded_size(x::HParamInfo)
    ...
    x.differs != false && (encoded_size += PB._encoded_size(x.differs, 7))
    return encoded_size
end
...
PB.default_values(::Type{ColParams}) = (;metric = nothing, hparam = "", order = SortOrder.ORDER_UNSPECIFIED, missing_values_first = false, filter_regexp = "", filter_interval = nothing, filter_discrete = nothing, exclude_missing_values = false, include_in_result = false)
PB.field_numbers(::Type{ColParams}) = (;metric = 1, hparam = 2, order = 3, missing_values_first = 4, filter_regexp = 5, filter_interval = 6, filter_discrete = 7, exclude_missing_values = 8, include_in_result = 9)

function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ColParams}, _endpos::Int=0, _group::Bool=false)
    name = nothing
    ...
    while !PB.message_done(d, _endpos, _group)
        ...
        elseif field_number == 9
            include_in_result = PB.decode(d, Bool)
        else
            Base.skip(d, wire_type)
        end
    end
    return ColParams(name, order, missing_values_first, filter, exclude_missing_values, include_in_result)
end
...
function PB.encode(e::PB.AbstractProtoEncoder, x::ColParams)
    ...
    x.include_in_result != false && PB.encode(e, 9, x.include_in_result)
    return position(e.io) - initpos
end
function PB._encoded_size(x::ColParams)
    ...
    x.include_in_result != false && (encoded_size += PB._encoded_size(x.include_in_result, 9))
    return encoded_size
end
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ListMetricEvalsRequest}, _endpos::Int=0, _group::Bool=false)
    experiment_name = ""
    session_name = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:MetricInfo}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:MetricValue}, _endpos::Int=0, _group::Bool=false)
    name = Ref{Union{Nothing,MetricName}}(nothing)
    value = zero(Float64)
...
PB.default_values(::Type{ListSessionGroupsRequest}) = (;experiment_name = "", allowed_statuses = Vector{Status.T}(), col_params = Vector{ColParams}(), aggregation_type = AggregationType.AGGREGATION_UNSET, aggregation_metric = nothing, start_index = zero(Int32), slice_size = zero(Int32), include_metrics = false)
PB.field_numbers(::Type{ListSessionGroupsRequest}) = (;experiment_name = 6, allowed_statuses = 7, col_params = 1, aggregation_type = 2, aggregation_metric = 3, start_index = 4, slice_size = 5, include_metrics = 8)

function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ListSessionGroupsRequest}, _endpos::Int=0, _group::Bool=false)
    experiment_name = ""
    ...
    return ListSessionGroupsRequest(experiment_name, allowed_statuses[], col_params[], aggregation_type, aggregation_metric[], start_index, slice_size, include_metrics)
end
...
function PB.encode(e::PB.AbstractProtoEncoder, x::ListSessionGroupsRequest)
    ...
    x.include_metrics != false && PB.encode(e, 8, x.include_metrics)
    return position(e.io) - initpos
end
function PB._encoded_size(x::ListSessionGroupsRequest)
    ...
    x.include_metrics != false && (encoded_size += PB._encoded_size(x.include_metrics, 8))
    return encoded_size
end
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:Experiment}, _endpos::Int=0, _group::Bool=false)
    name = ""
    description = ""
    user = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:Session}, _endpos::Int=0, _group::Bool=false)
    name = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SessionGroup}, _endpos::Int=0, _group::Bool=false)
    name = ""
    hparams = Dict{String,google.protobuf.Value}()
    metric_values = PB.BufferedVector{MetricValue}()
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ListSessionGroupsResponse}, _endpos::Int=0, _group::Bool=false)

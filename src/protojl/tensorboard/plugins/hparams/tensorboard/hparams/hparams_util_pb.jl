...
# original file: tensorboard/plugins/hparams/hparams_util.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:MetricInfosList}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:HParams}, _endpos::Int=0, _group::Bool=false)
    hparams = Dict{String,google.protobuf.Value}()
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
        if field_number == 1
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:HParamInfosList}, _endpos::Int=0, _group::Bool=false)

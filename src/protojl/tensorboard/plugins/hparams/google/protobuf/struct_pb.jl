...
# original file: google/protobuf/struct.proto (proto3 syntax)

import ProtoBuf as PB
using ProtoBuf: OneOf
using ProtoBuf.EnumX: @enumx

export NullValue, ListValue, Struct, Value
abstract type var"##Abstract#Struct" end
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:Struct}, _endpos::Int=0, _group::Bool=false)

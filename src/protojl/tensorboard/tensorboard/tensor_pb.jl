...
# original file: tensorboard/compat/proto/tensor.proto (proto3 syntax)
...
abstract type var"##Abstract#TensorProto" end
abstract type var"##Abstract#VariantTensorDataProto" end


# Stub definitions for cyclic types
struct var"##Stub#TensorProto"{T1<:var"##Abstract#VariantTensorDataProto"} <: var"##Abstract#TensorProto"
...
struct var"##Stub#VariantTensorDataProto" <: var"##Abstract#VariantTensorDataProto"
    type_name::String
    metadata::Vector{UInt8}
    tensors::Vector{var"##Stub#TensorProto"{var"##Stub#VariantTensorDataProto"}}
end

const TensorProto = var"##Stub#TensorProto"{var"##Stub#VariantTensorDataProto"}
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:TensorProto}, _endpos::Int=0, _group::Bool=false)
...
const VariantTensorDataProto = var"##Stub#VariantTensorDataProto"
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:VariantTensorDataProto}, _endpos::Int=0, _group::Bool=false)
    type_name = ""
    metadata = UInt8[]

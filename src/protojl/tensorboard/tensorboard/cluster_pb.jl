...
# original file: tensorboard/compat/proto/cluster.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:JobDef}, _endpos::Int=0, _group::Bool=false)
    name = ""
    tasks = Dict{Int32,String}()
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ClusterDef}, _endpos::Int=0, _group::Bool=false)

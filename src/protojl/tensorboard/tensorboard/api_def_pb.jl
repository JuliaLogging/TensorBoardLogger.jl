...
# original file: tensorboard/compat/proto/api_def.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"ApiDef.Attr"}, _endpos::Int=0, _group::Bool=false)
    name = ""
    rename_to = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"ApiDef.Endpoint"}, _endpos::Int=0, _group::Bool=false)
    name = ""
    deprecated = false
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"ApiDef.Arg"}, _endpos::Int=0, _group::Bool=false)
    name = ""
    rename_to = ""
    description = ""
    while !PB.message_done(d, _endpos, _group)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ApiDef}, _endpos::Int=0, _group::Bool=false)
    graph_op_name = ""
    deprecation_message = ""
    deprecation_version = zero(Int32)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ApiDefs}, _endpos::Int=0, _group::Bool=false)

...
# original file: tensorboard/compat/proto/step_stats.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:MemoryStats}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:AllocationRecord}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:NodeOutput}, _endpos::Int=0, _group::Bool=false)
    slot = zero(Int32)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:AllocatorMemoryUsed}, _endpos::Int=0, _group::Bool=false)
    allocator_name = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:NodeExecStats}, _endpos::Int=0, _group::Bool=false)
    node_name = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:DeviceStepStats}, _endpos::Int=0, _group::Bool=false)
    device = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:StepStats}, _endpos::Int=0, _group::Bool=false)

...
# original file: tensorboard/compat/proto/saver.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SaverDef}, _endpos::Int=0, _group::Bool=false)

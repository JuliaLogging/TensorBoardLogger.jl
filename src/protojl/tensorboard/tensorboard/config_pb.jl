...
# original file: tensorboard/compat/proto/config.proto (proto3 syntax)

import ProtoBuf as PB
using ProtoBuf: OneOf
using ProtoBuf.EnumX: @enumx

export var"GPUOptions.Experimental.StreamMergeOptions", var"OptimizerOptions.Level"
export BatchingOptions, var"GPUOptions.Experimental.VirtualDevices", ThreadPoolOptionProto
export var"OptimizerOptions.GlobalJitLevel", var"RunMetadata.FunctionGraphs"
export TensorConnection, var"ConfigProto.Experimental.MlirBridgeRollout"
export var"RunOptions.TraceLevel", var"RunOptions.Experimental.RunHandlerPoolOptions"
export SessionMetadata, var"GPUOptions.Experimental", OptimizerOptions
export var"RunOptions.Experimental", var"ConfigProto.Experimental", RunMetadata, GPUOptions
export GraphOptions, RunOptions, ConfigProto, CallableOptions


struct var"GPUOptions.Experimental.StreamMergeOptions"
    merge_host_to_device_stream::Bool
    merge_device_to_host_stream::Bool
    merge_device_to_device_stream::Bool
end
PB.default_values(::Type{var"GPUOptions.Experimental.StreamMergeOptions"}) = (;merge_host_to_device_stream = false, merge_device_to_host_stream = false, merge_device_to_device_stream = false)
PB.field_numbers(::Type{var"GPUOptions.Experimental.StreamMergeOptions"}) = (;merge_host_to_device_stream = 1, merge_device_to_host_stream = 2, merge_device_to_device_stream = 3)

function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"GPUOptions.Experimental.StreamMergeOptions"}, _endpos::Int=0, _group::Bool=false)
    merge_host_to_device_stream = false
    merge_device_to_host_stream = false
    merge_device_to_device_stream = false
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
        if field_number == 1
            merge_host_to_device_stream = PB.decode(d, Bool)
        elseif field_number == 2
            merge_device_to_host_stream = PB.decode(d, Bool)
        elseif field_number == 3
            merge_device_to_device_stream = PB.decode(d, Bool)
        else
            Base.skip(d, wire_type)
        end
    end
    return var"GPUOptions.Experimental.StreamMergeOptions"(merge_host_to_device_stream, merge_device_to_host_stream, merge_device_to_device_stream)
end

function PB.encode(e::PB.AbstractProtoEncoder, x::var"GPUOptions.Experimental.StreamMergeOptions")
    initpos = position(e.io)
    x.merge_host_to_device_stream != false && PB.encode(e, 1, x.merge_host_to_device_stream)
    x.merge_device_to_host_stream != false && PB.encode(e, 2, x.merge_device_to_host_stream)
    x.merge_device_to_device_stream != false && PB.encode(e, 3, x.merge_device_to_device_stream)
    return position(e.io) - initpos
end
function PB._encoded_size(x::var"GPUOptions.Experimental.StreamMergeOptions")
    encoded_size = 0
    x.merge_host_to_device_stream != false && (encoded_size += PB._encoded_size(x.merge_host_to_device_stream, 1))
    x.merge_device_to_host_stream != false && (encoded_size += PB._encoded_size(x.merge_device_to_host_stream, 2))
    x.merge_device_to_device_stream != false && (encoded_size += PB._encoded_size(x.merge_device_to_device_stream, 3))
    return encoded_size
end
...
struct BatchingOptions
    num_batch_threads::Int32
    max_batch_size::Int32
    batch_timeout_micros::Int32
    allowed_batch_sizes::Vector{Int32}
    max_enqueued_batches::Int32
end
PB.default_values(::Type{BatchingOptions}) = (;num_batch_threads = zero(Int32), max_batch_size = zero(Int32), batch_timeout_micros = zero(Int32), allowed_batch_sizes = Vector{Int32}(), max_enqueued_batches = zero(Int32))
PB.field_numbers(::Type{BatchingOptions}) = (;num_batch_threads = 1, max_batch_size = 2, batch_timeout_micros = 3, allowed_batch_sizes = 4, max_enqueued_batches = 5)

function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:BatchingOptions}, _endpos::Int=0, _group::Bool=false)
    num_batch_threads = zero(Int32)
    max_batch_size = zero(Int32)
    batch_timeout_micros = zero(Int32)
    allowed_batch_sizes = PB.BufferedVector{Int32}()
    max_enqueued_batches = zero(Int32)
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
        if field_number == 1
            num_batch_threads = PB.decode(d, Int32)
        elseif field_number == 2
            max_batch_size = PB.decode(d, Int32)
        elseif field_number == 3
            batch_timeout_micros = PB.decode(d, Int32)
        elseif field_number == 4
            PB.decode!(d, wire_type, allowed_batch_sizes)
        elseif field_number == 5
            max_enqueued_batches = PB.decode(d, Int32)
        else
            Base.skip(d, wire_type)
        end
    end
    return BatchingOptions(num_batch_threads, max_batch_size, batch_timeout_micros, allowed_batch_sizes[], max_enqueued_batches)
end

function PB.encode(e::PB.AbstractProtoEncoder, x::BatchingOptions)
    initpos = position(e.io)
    x.num_batch_threads != zero(Int32) && PB.encode(e, 1, x.num_batch_threads)
    x.max_batch_size != zero(Int32) && PB.encode(e, 2, x.max_batch_size)
    x.batch_timeout_micros != zero(Int32) && PB.encode(e, 3, x.batch_timeout_micros)
    !isempty(x.allowed_batch_sizes) && PB.encode(e, 4, x.allowed_batch_sizes)
    x.max_enqueued_batches != zero(Int32) && PB.encode(e, 5, x.max_enqueued_batches)
    return position(e.io) - initpos
end
function PB._encoded_size(x::BatchingOptions)
    encoded_size = 0
    x.num_batch_threads != zero(Int32) && (encoded_size += PB._encoded_size(x.num_batch_threads, 1))
    x.max_batch_size != zero(Int32) && (encoded_size += PB._encoded_size(x.max_batch_size, 2))
    x.batch_timeout_micros != zero(Int32) && (encoded_size += PB._encoded_size(x.batch_timeout_micros, 3))
    !isempty(x.allowed_batch_sizes) && (encoded_size += PB._encoded_size(x.allowed_batch_sizes, 4))
    x.max_enqueued_batches != zero(Int32) && (encoded_size += PB._encoded_size(x.max_enqueued_batches, 5))
    return encoded_size
end
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"GPUOptions.Experimental.VirtualDevices"}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ThreadPoolOptionProto}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"RunMetadata.FunctionGraphs"}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:TensorConnection}, _endpos::Int=0, _group::Bool=false)
    from_tensor = ""
    to_tensor = ""
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"RunOptions.Experimental.RunHandlerPoolOptions"}, _endpos::Int=0, _group::Bool=false)
    priority = zero(Int64)
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
        if field_number == 1
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SessionMetadata}, _endpos::Int=0, _group::Bool=false)
    name = ""
    version = zero(Int64)
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
...
struct var"GPUOptions.Experimental"
    ...
    num_virtual_devices_per_gpu::Int32
    ...
    gpu_system_memory_size_in_mb::Int32
    populate_pjrt_gpu_client_creation_info::Bool
    node_id::Int32
    stream_merge_options::Union{Nothing,var"GPUOptions.Experimental.StreamMergeOptions"}
end
PB.default_values(::Type{var"GPUOptions.Experimental"}) = (;virtual_devices = Vector{var"GPUOptions.Experimental.VirtualDevices"}(), num_virtual_devices_per_gpu = zero(Int32), use_unified_memory = false, num_dev_to_dev_copy_streams = zero(Int32), collective_ring_order = "", timestamped_allocator = false, kernel_tracker_max_interval = zero(Int32), kernel_tracker_max_bytes = zero(Int32), kernel_tracker_max_pending = zero(Int32), internal_fragmentation_fraction = zero(Float64), use_cuda_malloc_async = false, disallow_retry_on_allocation_failure = false, gpu_host_mem_limit_in_mb = zero(Float32), gpu_host_mem_disallow_growth = false, gpu_system_memory_size_in_mb = zero(Int32), populate_pjrt_gpu_client_creation_info = false, node_id = zero(Int32), stream_merge_options = nothing)
PB.field_numbers(::Type{var"GPUOptions.Experimental"}) = (;virtual_devices = 1, num_virtual_devices_per_gpu = 15, use_unified_memory = 2, num_dev_to_dev_copy_streams = 3, collective_ring_order = 4, timestamped_allocator = 5, kernel_tracker_max_interval = 7, kernel_tracker_max_bytes = 8, kernel_tracker_max_pending = 9, internal_fragmentation_fraction = 10, use_cuda_malloc_async = 11, disallow_retry_on_allocation_failure = 12, gpu_host_mem_limit_in_mb = 13, gpu_host_mem_disallow_growth = 14, gpu_system_memory_size_in_mb = 16, populate_pjrt_gpu_client_creation_info = 17, node_id = 18, stream_merge_options = 19)

function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"GPUOptions.Experimental"}, _endpos::Int=0, _group::Bool=false)
    virtual_devices = PB.BufferedVector{var"GPUOptions.Experimental.VirtualDevices"}()
    num_virtual_devices_per_gpu = zero(Int32)
    ...
    gpu_system_memory_size_in_mb = zero(Int32)
    populate_pjrt_gpu_client_creation_info = false
    node_id = zero(Int32)
    stream_merge_options = Ref{Union{Nothing,var"GPUOptions.Experimental.StreamMergeOptions"}}(nothing)
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
        if field_number == 1
            PB.decode!(d, virtual_devices)
        elseif field_number == 15
            num_virtual_devices_per_gpu = PB.decode(d, Int32)
        elseif field_number == 2
...
function PB.encode(e::PB.AbstractProtoEncoder, x::var"GPUOptions.Experimental")
    ...
    x.num_virtual_devices_per_gpu != zero(Int32) && PB.encode(e, 15, x.num_virtual_devices_per_gpu)
    ...
    x.gpu_system_memory_size_in_mb != zero(Int32) && PB.encode(e, 16, x.gpu_system_memory_size_in_mb)
    x.populate_pjrt_gpu_client_creation_info != false && PB.encode(e, 17, x.populate_pjrt_gpu_client_creation_info)
    x.node_id != zero(Int32) && PB.encode(e, 18, x.node_id)
    !isnothing(x.stream_merge_options) && PB.encode(e, 19, x.stream_merge_options)
    return position(e.io) - initpos
end
function PB._encoded_size(x::var"GPUOptions.Experimental")
    ...
    x.num_virtual_devices_per_gpu != zero(Int32) && (encoded_size += PB._encoded_size(x.num_virtual_devices_per_gpu, 15))
    ...
    x.gpu_system_memory_size_in_mb != zero(Int32) && (encoded_size += PB._encoded_size(x.gpu_system_memory_size_in_mb, 16))
    x.populate_pjrt_gpu_client_creation_info != false && (encoded_size += PB._encoded_size(x.populate_pjrt_gpu_client_creation_info, 17))
    x.node_id != zero(Int32) && (encoded_size += PB._encoded_size(x.node_id, 18))
    !isnothing(x.stream_merge_options) && (encoded_size += PB._encoded_size(x.stream_merge_options, 19))
    return encoded_size
end
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:OptimizerOptions}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"RunOptions.Experimental"}, _endpos::Int=0, _group::Bool=false)
...
struct var"ConfigProto.Experimental"
    ...
    tfrt_use_ifrt::Bool
    backend_server_port::Int32
    target_tpu::Bool
    target_gpu::Bool
    stream_merge_threshold::Int32
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"ConfigProto.Experimental"}, _endpos::Int=0, _group::Bool=false)
    ...
    tfrt_use_ifrt = false
    backend_server_port = zero(Int32)
    target_tpu = false
    target_gpu = false
    stream_merge_threshold = zero(Int32)
    ...
    disable_eager_executor_streaming_enqueue = false
    finalize_function_library_runtime = false
    finalize_resource_manager = false
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
        if field_number == 1
        ...
        elseif field_number == 27
            enable_multi_host = PB.decode(d, Bool)
        elseif field_number == 32
            tfrt_use_ifrt = PB.decode(d, Bool)
        elseif field_number == 28
            backend_server_port = PB.decode(d, Int32)
        elseif field_number == 29
            target_tpu = PB.decode(d, Bool)
        elseif field_number == 30
            target_gpu = PB.decode(d, Bool)
        elseif field_number == 31
            stream_merge_threshold = PB.decode(d, Int32)
...
function PB.encode(e::PB.AbstractProtoEncoder, x::var"ConfigProto.Experimental")
    ...
    x.enable_multi_host != false && PB.encode(e, 27, x.enable_multi_host)
    x.tfrt_use_ifrt != false && PB.encode(e, 32, x.tfrt_use_ifrt)
    x.backend_server_port != zero(Int32) && PB.encode(e, 28, x.backend_server_port)
    x.target_tpu != false && PB.encode(e, 29, x.target_tpu)
    x.target_gpu != false && PB.encode(e, 30, x.target_gpu)
    x.stream_merge_threshold != zero(Int32) && PB.encode(e, 31, x.stream_merge_threshold)
    ...
    x.disable_eager_executor_streaming_enqueue != false && PB.encode(e, 26, x.disable_eager_executor_streaming_enqueue)
    x.finalize_function_library_runtime != false && PB.encode(e, 33, x.finalize_function_library_runtime)
    x.finalize_resource_manager != false && PB.encode(e, 34, x.finalize_resource_manager)
    return position(e.io) - initpos
end
function PB._encoded_size(x::var"ConfigProto.Experimental")
    ...
    x.enable_multi_host != false && (encoded_size += PB._encoded_size(x.enable_multi_host, 27))
    x.tfrt_use_ifrt != false && (encoded_size += PB._encoded_size(x.tfrt_use_ifrt, 32))
    x.backend_server_port != zero(Int32) && (encoded_size += PB._encoded_size(x.backend_server_port, 28))
    x.target_tpu != false && (encoded_size += PB._encoded_size(x.target_tpu, 29))
    x.target_gpu != false && (encoded_size += PB._encoded_size(x.target_gpu, 30))
    x.stream_merge_threshold != zero(Int32) && (encoded_size += PB._encoded_size(x.stream_merge_threshold, 31))
    ...
    x.disable_eager_executor_streaming_enqueue != false && (encoded_size += PB._encoded_size(x.disable_eager_executor_streaming_enqueue, 26))
    x.finalize_function_library_runtime != false && (encoded_size += PB._encoded_size(x.finalize_function_library_runtime, 33))
    x.finalize_resource_manager != false && (encoded_size += PB._encoded_size(x.finalize_resource_manager, 34))
    return encoded_size
end
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:RunMetadata}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:GPUOptions}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:GraphOptions}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:RunOptions}, _endpos::Int=0, _group::Bool=false)
...
struct ConfigProto
    ...
    pluggable_device_options::Union{Nothing,GPUOptions}
...
PB.field_numbers(::Type{ConfigProto}) = (;device_count = 1, intra_op_parallelism_threads = 2, inter_op_parallelism_threads = 5, use_per_session_threads = 9, session_inter_op_thread_pool = 12, placement_period = 3, device_filters = 4, gpu_options = 6, pluggable_device_options = 18, allow_soft_placement = 7, log_device_placement = 8, graph_options = 10, operation_timeout_in_ms = 11, rpc_options = 13, cluster_def = 14, isolate_session_state = 15, share_cluster_devices_in_session = 17, experimental = 16)

function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ConfigProto}, _endpos::Int=0, _group::Bool=false)
    device_count = Dict{String,Int32}()
    ...
    pluggable_device_options = Ref{Union{Nothing,GPUOptions}}(nothing)
    ...
    while !PB.message_done(d, _endpos, _group)
        ...
        elseif field_number == 18
            PB.decode!(d, pluggable_device_options)
        elseif field_number == 7
...
function PB.encode(e::PB.AbstractProtoEncoder, x::ConfigProto)
    ...
    !isnothing(x.pluggable_device_options) && PB.encode(e, 18, x.pluggable_device_options)
...
function PB._encoded_size(x::ConfigProto)
    ...
    !isnothing(x.pluggable_device_options) && (encoded_size += PB._encoded_size(x.pluggable_device_options, 18))
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:CallableOptions}, _endpos::Int=0, _group::Bool=false)

...
# original file: tensorboard/compat/proto/allocation_description.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:AllocationDescription}, _endpos::Int=0, _group::Bool=false)

...
# original file: tensorboard/compat/proto/full_type.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:FullTypeDef}, _endpos::Int=0, _group::Bool=false)

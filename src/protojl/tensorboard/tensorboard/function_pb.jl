...
# original file: tensorboard/compat/proto/function.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:RegisteredGradient}, _endpos::Int=0, _group::Bool=false)
    gradient_func = ""
    registered_op_type = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"FunctionDef.ArgAttrs"}, _endpos::Int=0, _group::Bool=false)
    attr = Dict{String,AttrValue}()
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
        if field_number == 1
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:GradientDef}, _endpos::Int=0, _group::Bool=false)
    function_name = ""
    gradient_func = ""
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:FunctionDef}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:FunctionDefLibrary}, _endpos::Int=0, _group::Bool=false)

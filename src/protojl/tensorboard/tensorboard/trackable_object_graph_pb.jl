...
# original file: tensorboard/compat/proto/trackable_object_graph.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"TrackableObjectGraph.TrackableObject.ObjectReference"}, _endpos::Int=0, _group::Bool=false)
    node_id = zero(Int32)
    local_name = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"TrackableObjectGraph.TrackableObject.SerializedTensor"}, _endpos::Int=0, _group::Bool=false)
    name = ""
    full_name = ""
    checkpoint_key = ""
    while !PB.message_done(d, _endpos, _group)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"TrackableObjectGraph.TrackableObject.SlotVariableReference"}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:RegisteredSaver}, _endpos::Int=0, _group::Bool=false)
    name = ""
    object_name = ""
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"TrackableObjectGraph.TrackableObject"}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:TrackableObjectGraph}, _endpos::Int=0, _group::Bool=false)

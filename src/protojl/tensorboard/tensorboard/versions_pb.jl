...
# original file: tensorboard/compat/proto/versions.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:VersionDef}, _endpos::Int=0, _group::Bool=false)
    producer = zero(Int32)

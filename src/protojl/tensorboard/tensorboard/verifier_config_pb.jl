...
# original file: tensorboard/compat/proto/verifier_config.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:VerifierConfig}, _endpos::Int=0, _group::Bool=false)

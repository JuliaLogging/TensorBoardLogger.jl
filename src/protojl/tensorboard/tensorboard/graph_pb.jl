...
# original file: tensorboard/compat/proto/graph.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:GraphDef}, _endpos::Int=0, _group::Bool=false)

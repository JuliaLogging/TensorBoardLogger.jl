...
# original file: tensorboard/compat/proto/meta_graph.proto (proto3 syntax)
...
export AssetFileDef, SignatureDef, TensorInfo, var"TensorInfo.CompositeTensor"
export MetaGraphDef
abstract type var"##Abstract#MetaGraphDef" end
abstract type var"##Abstract#SignatureDef" end
abstract type var"##Abstract#TensorInfo" end
abstract type var"##Abstract#AssetFileDef" end
abstract type var"##Abstract#TensorInfo.CompositeTensor" end
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"CollectionDef.BytesList"}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"CollectionDef.Int64List"}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"TensorInfo.CooSparse"}, _endpos::Int=0, _group::Bool=false)
    values_tensor_name = ""
    indices_tensor_name = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"CollectionDef.NodeList"}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"CollectionDef.AnyList"}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"CollectionDef.FloatList"}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"MetaGraphDef.MetaInfoDef"}, _endpos::Int=0, _group::Bool=false)
    meta_graph_version = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:CollectionDef}, _endpos::Int=0, _group::Bool=false)
    kind = nothing
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
        if field_number == 1
...
struct var"##Stub#AssetFileDef"{T1<:var"##Abstract#TensorInfo"} <: var"##Abstract#AssetFileDef"
    tensor_info::Union{Nothing,T1}
    filename::String
end

struct var"##Stub#SignatureDef"{T1<:var"##Abstract#TensorInfo"} <: var"##Abstract#SignatureDef"
    inputs::Dict{String,T1}
    outputs::Dict{String,T1}
    method_name::String
    defaults::Dict{String,TensorProto}
end

struct var"##Stub#TensorInfo"{T1<:var"##Abstract#TensorInfo.CompositeTensor"} <: var"##Abstract#TensorInfo"
    encoding::Union{Nothing,OneOf{<:Union{String,var"TensorInfo.CooSparse",T1}}}
    dtype::var"#DataType".T
    tensor_shape::Union{Nothing,TensorShapeProto}
end

struct var"##Stub#TensorInfo.CompositeTensor" <: var"##Abstract#TensorInfo.CompositeTensor"
    type_spec::Union{Nothing,TypeSpecProto}
    components::Vector{var"##Stub#TensorInfo"{var"##Stub#TensorInfo.CompositeTensor"}}
end

struct var"##Stub#MetaGraphDef" <: var"##Abstract#MetaGraphDef"
    ...
    signature_def::Dict{String,var"##Stub#SignatureDef"{var"##Stub#TensorInfo"{var"##Stub#TensorInfo.CompositeTensor"}}}
    asset_file_def::Vector{var"##Stub#AssetFileDef"{var"##Stub#TensorInfo"{var"##Stub#TensorInfo.CompositeTensor"}}}
    object_graph_def::Union{Nothing,SavedObjectGraph}
end

const AssetFileDef = var"##Stub#AssetFileDef"{var"##Stub#TensorInfo"{var"##Stub#TensorInfo.CompositeTensor"}}
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:AssetFileDef}, _endpos::Int=0, _group::Bool=false)
...
const SignatureDef = var"##Stub#SignatureDef"{var"##Stub#TensorInfo"{var"##Stub#TensorInfo.CompositeTensor"}}
PB.default_values(::Type{SignatureDef}) = (;inputs = Dict{String,TensorInfo}(), outputs = Dict{String,TensorInfo}(), method_name = "", defaults = Dict{String,TensorProto}())
PB.field_numbers(::Type{SignatureDef}) = (;inputs = 1, outputs = 2, method_name = 3, defaults = 4)

function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SignatureDef}, _endpos::Int=0, _group::Bool=false)
    ...
    return SignatureDef(inputs, outputs, method_name, defaults)
end
...
function PB.encode(e::PB.AbstractProtoEncoder, x::SignatureDef)
    ...
    !isempty(x.defaults) && PB.encode(e, 4, x.defaults)
    return position(e.io) - initpos
end
function PB._encoded_size(x::SignatureDef)
    ...
    !isempty(x.defaults) && (encoded_size += PB._encoded_size(x.defaults, 4))
    return encoded_size
end

const TensorInfo = var"##Stub#TensorInfo"{var"##Stub#TensorInfo.CompositeTensor"}
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:TensorInfo}, _endpos::Int=0, _group::Bool=false)
    encoding = nothing
...
const var"TensorInfo.CompositeTensor" = var"##Stub#TensorInfo.CompositeTensor"
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"TensorInfo.CompositeTensor"}, _endpos::Int=0, _group::Bool=false)
...
const MetaGraphDef = var"##Stub#MetaGraphDef"
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:MetaGraphDef}, _endpos::Int=0, _group::Bool=false)

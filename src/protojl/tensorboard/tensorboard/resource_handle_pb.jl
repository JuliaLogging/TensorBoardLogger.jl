...
# original file: tensorboard/compat/proto/resource_handle.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"ResourceHandleProto.DtypeAndShape"}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ResourceHandleProto}, _endpos::Int=0, _group::Bool=false)
    device = ""
    container = ""
    name = ""

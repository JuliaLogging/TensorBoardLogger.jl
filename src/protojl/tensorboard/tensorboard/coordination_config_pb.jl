...
# original file: tensorboard/compat/proto/coordination_config.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:CoordinatedJob}, _endpos::Int=0, _group::Bool=false)
    name = ""
...
struct CoordinationServiceConfig
    ...
    cluster_register_with_barrier::Bool
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:CoordinationServiceConfig}, _endpos::Int=0, _group::Bool=false)
    ...
    force_disable = false
    poll_for_error_from_service_at_startup = false
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
        if field_number == 1
        ...
        elseif field_number == 14
            cluster_register_with_barrier = PB.decode(d, Bool)
        ...
        elseif field_number == 12
            force_disable = PB.decode(d, Bool)
        elseif field_number == 13
            poll_for_error_from_service_at_startup = PB.decode(d, Bool)
        else
            Base.skip(d, wire_type)
        end
    end
    return CoordinationServiceConfig(service_type, service_leader, enable_health_check, cluster_register_timeout_in_ms, cluster_register_with_barrier, heartbeat_timeout_in_ms, coordinated_job_list[], shutdown_barrier_timeout_in_ms, agent_destruction_without_shutdown, recoverable_jobs[], allow_new_incarnation_to_reconnect, force_disable, poll_for_error_from_service_at_startup)
end
...
function PB.encode(e::PB.AbstractProtoEncoder, x::CoordinationServiceConfig)
    ...
    x.cluster_register_with_barrier != false && PB.encode(e, 14, x.cluster_register_with_barrier)
    ...
    x.force_disable != false && PB.encode(e, 12, x.force_disable)
    x.poll_for_error_from_service_at_startup != false && PB.encode(e, 13, x.poll_for_error_from_service_at_startup)
    return position(e.io) - initpos
end
function PB._encoded_size(x::CoordinationServiceConfig)
    ...
    x.cluster_register_with_barrier != false && (encoded_size += PB._encoded_size(x.cluster_register_with_barrier, 14))
    ...
    x.force_disable != false && (encoded_size += PB._encoded_size(x.force_disable, 12))
    x.poll_for_error_from_service_at_startup != false && (encoded_size += PB._encoded_size(x.poll_for_error_from_service_at_startup, 13))
    return encoded_size
end

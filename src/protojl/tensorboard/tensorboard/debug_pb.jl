...
# original file: tensorboard/compat/proto/debug.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:DebuggedSourceFile}, _endpos::Int=0, _group::Bool=false)
    host = ""
    file_path = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:DebugTensorWatch}, _endpos::Int=0, _group::Bool=false)
    node_name = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:DebuggedSourceFiles}, _endpos::Int=0, _group::Bool=false)

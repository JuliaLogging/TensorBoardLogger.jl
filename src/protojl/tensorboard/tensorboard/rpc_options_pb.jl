...
# original file: tensorboard/compat/proto/rpc_options.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:RPCOptions}, _endpos::Int=0, _group::Bool=false)

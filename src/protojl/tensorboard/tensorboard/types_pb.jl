...
# original file: tensorboard/compat/proto/types.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SerializedDType}, _endpos::Int=0, _group::Bool=false)

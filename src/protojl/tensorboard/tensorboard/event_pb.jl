...
# original file: tensorboard/compat/proto/event.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:WatchdogConfig}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:RequestedExitCode}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SourceMetadata}, _endpos::Int=0, _group::Bool=false)
    writer = ""
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
        if field_number == 1
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:TaggedRunMetadata}, _endpos::Int=0, _group::Bool=false)
    tag = ""
    run_metadata = UInt8[]
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
...
Base.depwarn("`var\"LogMessage.Level\"` is deprecated.", nameof(var"LogMessage.Level"))
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SessionLog}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:WorkerHeartbeatRequest}, _endpos::Int=0, _group::Bool=false)
...
Base.depwarn("`LogMessage` is deprecated.", nameof(LogMessage))
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:LogMessage}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:Event}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:WorkerHeartbeatResponse}, _endpos::Int=0, _group::Bool=false)

...
# original file: tensorboard/compat/proto/node_def.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"NodeDef.ExperimentalDebugInfo"}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:NodeDef}, _endpos::Int=0, _group::Bool=false)
    name = ""
    op = ""

...
# original file: tensorboard/compat/proto/tensor_shape.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"TensorShapeProto.Dim"}, _endpos::Int=0, _group::Bool=false)
    size = zero(Int64)
    name = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:TensorShapeProto}, _endpos::Int=0, _group::Bool=false)

...
# original file: tensorboard/compat/proto/tfprof_log.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:Tuple}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:Memory}, _endpos::Int=0, _group::Bool=false)
    bytes = zero(Int64)
    ptr = zero(UInt64)
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
...
PB.reserved_fields(::Type{var"CodeDef.Trace"}) = (names = ["file", "function", "line"], numbers = Union{Int,UnitRange{Int}}[1, 3, 4])
PB.default_values(::Type{var"CodeDef.Trace"}) = (;file_id = zero(Int64), lineno = zero(Int32), function_id = zero(Int64), line_id = zero(Int64), func_start_line = zero(Int32))
PB.field_numbers(::Type{var"CodeDef.Trace"}) = (;file_id = 6, lineno = 2, function_id = 7, line_id = 8, func_start_line = 5)

function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"CodeDef.Trace"}, _endpos::Int=0, _group::Bool=false)
    file_id = zero(Int64)
    lineno = zero(Int32)
    ...
    return var"CodeDef.Trace"(file_id, lineno, function_id, line_id, func_start_line)
end
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ExecTime}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ExecMemory}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:CodeDef}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ExecProfile}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:OpLogEntry}, _endpos::Int=0, _group::Bool=false)
    name = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ProfileNode}, _endpos::Int=0, _group::Bool=false)
    name = ""
    op = ""
    id = zero(Int64)
    inputs = Dict{Int32,Int64}()
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:OpLogProto}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ProfileProto}, _endpos::Int=0, _group::Bool=false)
    nodes = Dict{Int64,ProfileNode}()
    has_trace = false

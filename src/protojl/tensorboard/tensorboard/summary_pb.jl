...
# original file: tensorboard/compat/proto/summary.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"SummaryMetadata.PluginData"}, _endpos::Int=0, _group::Bool=false)
    plugin_name = ""
    content = UInt8[]
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"Summary.Audio"}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"Summary.Image"}, _endpos::Int=0, _group::Bool=false)
    height = zero(Int32)
    width = zero(Int32)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SummaryDescription}, _endpos::Int=0, _group::Bool=false)
    type_hint = ""
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
        if field_number == 1
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SummaryMetadata}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"Summary.Value"}, _endpos::Int=0, _group::Bool=false)
    node_name = ""
    tag = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:Summary}, _endpos::Int=0, _group::Bool=false)

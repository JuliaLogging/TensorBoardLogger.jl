...
# original file: tensorboard/compat/proto/cost_graph.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"CostGraphDef.Node.InputInfo"}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"CostGraphDef.AggregatedCost"}, _endpos::Int=0, _group::Bool=false)
    cost = zero(Float32)
    dimension = ""
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"CostGraphDef.Node.OutputInfo"}, _endpos::Int=0, _group::Bool=false)
    size = zero(Int64)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"CostGraphDef.Node"}, _endpos::Int=0, _group::Bool=false)
    name = ""
    device = ""
    id = zero(Int32)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:CostGraphDef}, _endpos::Int=0, _group::Bool=false)

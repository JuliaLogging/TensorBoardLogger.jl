...
# original file: tensorboard/compat/proto/saved_object_graph.proto (proto3 syntax)
...
export SavedResource, SavedVariable, var"FunctionSpec.JitCompile", SavedConstant
export FunctionSpec, SavedBareConcreteFunction, SavedFunction, SavedObject
export SavedObjectGraph
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SavedAsset}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:CapturedTensor}, _endpos::Int=0, _group::Bool=false)
    name = ""
    concrete_function = ""
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SavedUserObject}, _endpos::Int=0, _group::Bool=false)
    identifier = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SavedConcreteFunction}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SaveableObject}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SavedResource}, _endpos::Int=0, _group::Bool=false)
    device = ""
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
        if field_number == 1
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SavedVariable}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SavedConstant}, _endpos::Int=0, _group::Bool=false)
    operation = ""
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
        if field_number == 1
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:FunctionSpec}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SavedBareConcreteFunction}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SavedFunction}, _endpos::Int=0, _group::Bool=false)
...
struct SavedObject
    ...
    kind::Union{Nothing,OneOf{<:Union{SavedUserObject,SavedAsset,SavedFunction,SavedVariable,SavedBareConcreteFunction,SavedConstant,SavedResource,CapturedTensor}}}
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SavedObject}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SavedObjectGraph}, _endpos::Int=0, _group::Bool=false)

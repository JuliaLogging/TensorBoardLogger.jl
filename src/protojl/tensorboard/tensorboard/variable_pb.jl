...
# original file: tensorboard/compat/proto/variable.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SaveSliceInfoDef}, _endpos::Int=0, _group::Bool=false)
    full_name = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:VariableDef}, _endpos::Int=0, _group::Bool=false)
    variable_name = ""
    initial_value_name = ""
    initializer_name = ""
    snapshot_name = ""

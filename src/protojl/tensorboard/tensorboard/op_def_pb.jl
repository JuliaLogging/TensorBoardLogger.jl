...
# original file: tensorboard/compat/proto/op_def.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"OpDef.AttrDef"}, _endpos::Int=0, _group::Bool=false)
    name = ""
    var"#type" = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:OpDeprecation}, _endpos::Int=0, _group::Bool=false)
    version = zero(Int32)
    explanation = ""
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"OpDef.ArgDef"}, _endpos::Int=0, _group::Bool=false)
    name = ""
    description = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:OpList}, _endpos::Int=0, _group::Bool=false)

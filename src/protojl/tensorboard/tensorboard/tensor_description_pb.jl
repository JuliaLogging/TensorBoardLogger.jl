...
# original file: tensorboard/compat/proto/tensor_description.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:TensorDescription}, _endpos::Int=0, _group::Bool=false)

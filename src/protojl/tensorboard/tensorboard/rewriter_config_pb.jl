...
# original file: tensorboard/compat/proto/rewriter_config.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"RewriterConfig.CustomGraphOptimizer"}, _endpos::Int=0, _group::Bool=false)
    name = ""
    parameter_map = Dict{String,AttrValue}()
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ScopedAllocatorOptions}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:AutoParallelOptions}, _endpos::Int=0, _group::Bool=false)
    enable = false
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:RewriterConfig}, _endpos::Int=0, _group::Bool=false)
    ...
    while !PB.message_done(d, _endpos, _group)
        ...
        elseif field_number == 32
            disable_tfg_optimizer = PB.decode(d, Bool)
...
function PB.encode(e::PB.AbstractProtoEncoder, x::RewriterConfig)
    ...
    x.disable_tfg_optimizer != false && PB.encode(e, 32, x.disable_tfg_optimizer)
...
function PB._encoded_size(x::RewriterConfig)
    ...
    x.disable_tfg_optimizer != false && (encoded_size += PB._encoded_size(x.disable_tfg_optimizer, 32))

...
# original file: tensorboard/compat/proto/cpp_shape_inference.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:CppShapeInferenceInputsNeeded}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"CppShapeInferenceResult.HandleShapeAndType"}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"CppShapeInferenceResult.HandleData"}, _endpos::Int=0, _group::Bool=false)
    is_set = false
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:CppShapeInferenceResult}, _endpos::Int=0, _group::Bool=false)
    shape = Ref{Union{Nothing,TensorShapeProto}}(nothing)

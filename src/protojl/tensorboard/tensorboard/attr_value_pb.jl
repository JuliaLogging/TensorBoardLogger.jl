...
# original file: tensorboard/compat/proto/attr_value.proto (proto3 syntax)

import ProtoBuf as PB
using ProtoBuf: OneOf
using ProtoBuf.EnumX: @enumx

export var"AttrValue.ListValue", NameAttrList, AttrValue
abstract type var"##Abstract#NameAttrList" end
abstract type var"##Abstract#AttrValue.ListValue" end
abstract type var"##Abstract#AttrValue" end


# Stub definitions for cyclic types
struct var"##Stub#AttrValue.ListValue"{T1<:var"##Abstract#NameAttrList"} <: var"##Abstract#AttrValue.ListValue"
...
struct var"##Stub#NameAttrList"{T1<:var"##Abstract#AttrValue"} <: var"##Abstract#NameAttrList"
    name::String
    attr::Dict{String,T1}
end

struct var"##Stub#AttrValue" <: var"##Abstract#AttrValue"
    value::Union{Nothing,OneOf{<:Union{Vector{UInt8},Int64,Float32,Bool,var"#DataType".T,TensorShapeProto,TensorProto,var"##Stub#AttrValue.ListValue"{var"##Stub#NameAttrList"{var"##Stub#AttrValue"}},var"##Stub#NameAttrList"{var"##Stub#AttrValue"},String}}}
end

const var"AttrValue.ListValue" = var"##Stub#AttrValue.ListValue"{var"##Stub#NameAttrList"{var"##Stub#AttrValue"}}
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"AttrValue.ListValue"}, _endpos::Int=0, _group::Bool=false)
...
const NameAttrList = var"##Stub#NameAttrList"{var"##Stub#AttrValue"}
PB.default_values(::Type{NameAttrList}) = (;name = "", attr = Dict{String,AttrValue}())
PB.field_numbers(::Type{NameAttrList}) = (;name = 1, attr = 2)

function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:NameAttrList}, _endpos::Int=0, _group::Bool=false)
    name = ""
...
const AttrValue = var"##Stub#AttrValue"
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:AttrValue}, _endpos::Int=0, _group::Bool=false)
    value = nothing
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
        if field_number == 2
